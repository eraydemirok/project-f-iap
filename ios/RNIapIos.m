        ...
        if (receiptData == nil) {
            ...
            for (SKPaymentTransaction *item in transactions) {
                NSMutableDictionary *purchase = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                                 ...
                                                 [item.transactionReceipt base64EncodedStringWithOptions:0], @"transactionReceipt",
                                                 StringForTransactionState(item.transactionState),  @"transactionState",
                                                 nil
                                                 ];
    ...
    [self requestReceiptDataWithBlock:^(NSData *receiptData, NSError *error) {
        if (receiptData == nil) {
            ...
            NSMutableDictionary *purchase = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                             ...
                                             // [receiptData base64EncodedStringWithOptions:0], @"transactionReceipt",
                                             [transaction.transactionReceipt base64EncodedStringWithOptions:0], @"transactionReceipt",
                                             StringForTransactionState(transaction.transactionState),  @"transactionState",
                                             nil
                                             ];
...
/////////////////////////////////////////////////////////////////////////////////
// Satın alma verisinin durumunu filtreler. ( 18.11.2019 )
